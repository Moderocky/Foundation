...
public interface OpCode {
     ...
     * 3: iinc, index, const
     */
    UncheckedCode IINC = new UncheckedCode("IINC", Codes.IINC);
    /**
     * 1: <opcode>
     */
     ...
     * 2: ldc, index
     */
    UncheckedCode LDC = new UncheckedCode("LDC", Codes.LDC);
    /**
     ...
     */
    UncheckedCode WIDE = new UncheckedCode("WIDE", Codes.WIDE);
    ...
    record Instruction(String mnemonic, byte code) implements OpCode, CodeElement, RecordConstant {
        ...
        public String toString() {
            return this.mnemonic.toLowerCase() + "/" + Integer.toHexString(code);
        }
    ...
    record UncheckedCode(String mnemonic, byte code, int length) implements OpCode {
        ...
        public UncheckedElement of(UVec data) {
            return new UncheckedElement(code, data);
        }

        public UncheckedElement of(int unsignedBtye) {
            return new UncheckedElement(code, U1.valueOf(unsignedBtye));
        }
