...
import static org.valross.foundation.detail.Type.OBJECT;
...
public class CallConstructorTest extends FoundationTest {
    ...
    public void test() {
        ...
        main.line(RETURN.intValue(EQUALS.objects(method.get(LOAD_VAR.object(0), CONSTANT.of("hello")),
                                                 FIELD.of(System.class, "out", PrintStream.class)
                                                      .get())));
