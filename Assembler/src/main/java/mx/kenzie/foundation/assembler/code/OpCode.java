...
public interface OpCode {
    ...
    JumpCode GOTO = new JumpCode("GOTO", Codes.GOTO, JumpCode.Goto::new);
    JumpCode GOTO_W = new JumpCode("GOTO_W", Codes.GOTO_W, JumpCode.Goto::new);
    ...
    JumpCode IF_ACMPEQ = new JumpCode("IF_ACMPEQ", Codes.IF_ACMPEQ, JumpCode.Jump::new);
    JumpCode IF_ACMPNE = new JumpCode("IF_ACMPNE", Codes.IF_ACMPNE, JumpCode.Jump::new);
    JumpCode IF_ICMPEQ = new JumpCode("IF_ICMPEQ", Codes.IF_ICMPEQ, JumpCode.Jump::new);
    JumpCode IF_ICMPNE = new JumpCode("IF_ICMPNE", Codes.IF_ICMPNE, JumpCode.Jump::new);
    JumpCode IF_ICMPLT = new JumpCode("IF_ICMPLT", Codes.IF_ICMPLT, JumpCode.Jump::new);
    JumpCode IF_ICMPGE = new JumpCode("IF_ICMPGE", Codes.IF_ICMPGE, JumpCode.Jump::new);
    JumpCode IF_ICMPGT = new JumpCode("IF_ICMPGT", Codes.IF_ICMPGT, JumpCode.Jump::new);
    JumpCode IF_ICMPLE = new JumpCode("IF_ICMPLE", Codes.IF_ICMPLE, JumpCode.Jump::new);
    JumpCode IFEQ = new JumpCode("IFEQ", Codes.IFEQ, JumpCode.Jump::new);
    JumpCode IFNE = new JumpCode("IFNE", Codes.IFNE, JumpCode.Jump::new);
    JumpCode IFLT = new JumpCode("IFLT", Codes.IFLT, JumpCode.Jump::new);
    JumpCode IFGE = new JumpCode("IFGE", Codes.IFGE, JumpCode.Jump::new);
    JumpCode IFGT = new JumpCode("IFGT", Codes.IFGT, JumpCode.Jump::new);
    JumpCode IFLE = new JumpCode("IFLE", Codes.IFLE, JumpCode.Jump::new);
    JumpCode IFNONNULL = new JumpCode("IFNONNULL", Codes.IFNONNULL, JumpCode.Jump::new);
    JumpCode IFNULL = new JumpCode("IFNULL", Codes.IFNULL, JumpCode.Jump::new);
